...
def run_test_generate_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    expected = [rg.Point(52, 50),
                rg.Point(50, 48),
                rg.Point(48, 50),
                rg.Point(50, 52)]
    circle = rg.Circle(rg.Point(50, 50), 2)
...
def run_test_draw_points_on_circle():
    ...
    circle = rg.Circle(rg.Point(200, 250), 40)
    circle.fill_color = 'blue'
    draw_points_on_circle(window, circle, 8, 'black')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    # -------------------------------------------------------------------------
    title = 'Test 4'
    window = rg.RoseWindow(200, 200, title)
    circle = rg.Circle(rg.Point(100, 100), 50)
    circle.fill_color = 'yellow'
    pizza(window, circle, 20, 'black', 1)
    window.close_on_mouse_click()
...
def pizza(window, circle, number_of_slices, color, thickness):
    ...
    for i in range(len(points)):
        line = rg.Line(points[i], circle.center)
        line.color = color
...
def run_test_polygon():
    ...
    circle.outline_thickness = 3
    polygon(window, circle, 3, 'yellow', 20)
    window.close_on_mouse_click()
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    for i in range(len(points)):
        if i == len(points) - 1:
            line = rg.Line(points[i], points[0])
        else:
